...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <?php if(auth()->user()->rol->name === 'Administrador'): ?>
                ...
                <a href="<?php echo e(route('listaRegistrados')); ?>" class="selected">
                    <div class="option">
                        <i class="bi bi-people"></i>
                        <h4>Usuarios</h4>
                    </div>
                </a>
            <?php elseif(auth()->user()->rol->name === 'Docente'): ?>
                <a href="<?php echo e(route('docente.dashboard')); ?>">
                    <div class="option">
                ...
                <a href="<?php echo e(route('grupos.index')); ?>" class="selected">
                    <div class="option">
                        <i class="bi bi-people"></i>
                        <h4>Grupos</h4>
                    </div>
                ...
                <a href="<?php echo e(route('preguntas.index')); ?>" class="selected">
                    <div class="option">
                ...
                <a href="<?php echo e(route('avisos.create')); ?>" class="selected">
                    <div class="option">
                        <i class="bi bi-bell"></i>
            ...
            <?php elseif(auth()->user()->rol->name === 'Estudiante'): ?>

            <a href="<?php echo e(route('estudiante.dashboard')); ?>" class="selected">
                <div class="option">
                    <i class="bi bi-house"></i>
                    <h4>Inicio</h4>
                </div>
            ...
            <a href="<?php echo e(route('estudiante.inscripcion')); ?>" class="selected">
                <div class="option">
            ...
            <a href="<?php echo e(route('sprint-planner')); ?>" class="selected">
                <div class="option">
...
<?php /**PATH C:\Taller de ingenieria de software\ScoreGeist\resources\views/layouts/menu.blade.php ENDPATH**/ ?>