...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/menu.css')); ?>"> <!-- Asegúrate de que la ruta sea correcta -->
    <style>
        body {
        ...
        <div class="card" style="width: 400px;">
            <div class="card-body">
                ...
                <div class="mt-3 text-center">
                    <a href="<?php echo e(route('password.request')); ?>" class="link-secondary">¿Olvidaste tu contraseña?</a>
                </div>
            </div>
        </div>
    </div>
...
</html>  <?php /**PATH C:\Taller de ingenieria de software\ScoreGeist\resources\views/login.blade.php ENDPATH**/ ?>